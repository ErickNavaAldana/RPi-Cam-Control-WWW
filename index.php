...
<html>
  ...
  <body onload="setTimeout('init();', 100);">
      ...
      <div class="preview"><a href="clean.php"><img src="cam.jpg" id="mjpeg_dest" alt="Actual Image"></a></div>
      <div class="cammenu">
      <input id="video_button" type="button" value="Video">
      <input id="image_button" type="button" value="Image">
      <input id="timelapse_button" type="button" value="Time">
      <input id="md_button" type="button" value="Motion">
      <input id="halt_button" type="button" value="Stop">
      </div>
      <p><a href="preview.php">Download Videos and Images</a></p>
      <h2>Settings</h2>
      <table>
        <tr>
          <td class="ohead">Resolutions:</td>
          <td>
        ...
        <tr>
          <td class="ohead">Timelapse-Interval (0.1...3200):</td>
          <td><input type="text" size=4 id="tl_interval" value="3">s</td>
        </tr>
        <tr>
          <td class="ohead">Annotation (max 31 characters):</td>
          <td>
        ...
        <tr>
          <td class="ohead">Sharpness (-100...100), default 0:</td>
        ...
        <tr>
          <td class="ohead">Contrast (-100...100), default 0:</td>
        ...
        <tr>
          <td class="ohead">Brightness (0...100), default 50:</td>
        ...
        <tr>
          <td class="ohead">Saturation (-100...100), default 0:</td>
        ...
        <tr>
          <td class="ohead">White Balance, default 'auto':</td>
          <td>
        ...
        <tr>
          <td class="ohead">Image Effect, default 'none':</td>
          <td>
        ...
        <tr>
          <td class="ohead">Colour Effect, default 'disabled':</td>
          <td>
            <select id="ce_en">
        ...
        <tr>
          <td class="ohead">Rotation, default 0:</td>
          <td>
        ...
        <tr>
          <td class="ohead">Flip, default 'none':</td>
          <td>
        ...
        <tr>
          <td class="ohead">Sensor Region, default 0/0/65536/65536:</td>
          <td>
        ...
        <tr>
          <td class="ohead">Shutter speed (0...330000), default 0:</td>
        ...
        <tr>
          <td class="ohead">Image quality (0...100), default 85:</td>
